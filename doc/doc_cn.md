...
符号扩展，就是将数据的长度加倍，数值仍保持不变。

以下指令全部扩展为i64：

| 指令       | 参数个数 | 文本格式 | 描述               |
| ---------- | -------- | -------- | ------------------ |
| MIR_EXT8   | 2        | ext8     | 扩展有符号8位整数  |
| MIR_EXT16  | 2        | ext16    | 扩展有符号16位整数 |
| MIR_EXT32  | 2        | ext32    | 扩展有符号32位整数 |
| MIR_UEXT8  | 2        | uext8    | 扩展无符号8位整数  |
| MIR_UEXT16 | 2        | uext16   | 扩展无符号16位整数 |
| MIR_UEXT32 | 2        | uext32   | 扩展无符号32位整数 |
